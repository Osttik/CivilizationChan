...
public class PentagonCreator : ScriptableWizard
{
	...
	{
		ScriptableWizard.DisplayWizard("Create Cone", typeof(PentagonCreator));
	}

	void OnWizardCreate()
	{
		GameObject newCone = new GameObject("Pentagon");
